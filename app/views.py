...
def logs(request):
    ...
    context = {
        ...
        "stats": {
            ...
            "patient_count": HospitalStay.objects.filter(hospital=hospital,
                                                         patient__groups__name='Patient').distinct().count(),
            "doctor_count": HospitalStay.objects.filter(hospital=hospital,
                                                        patient__groups__name='Doctor').distinct().count(),
            "nurse_count": HospitalStay.objects.filter(hospital=hospital,
                                                       patient__groups__name='Nurse').distinct().count(),
